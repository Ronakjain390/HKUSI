            ...
            <table class="table">
                <tbody>
                    <tr>
                        ...
                        <td>
                        <select class="form-control form-select programmeYear" name="programme_id[]" >
                              <!--
...
<script>
    ...
    $(".allSelectProgramme").click(function(){ alert('t1');
        if($(".allSelectProgramme").is(':checked') ){ 
            $(".programmeAccordingtoYear > option").prop("selected","selected");
            $(".programmeAccordingtoYear").trigger("change");
        }else{
            $(".programmeAccordingtoYear > option").removeAttr("selected");
             $(".programmeAccordingtoYear").trigger("change");
         }
    });
</script>
