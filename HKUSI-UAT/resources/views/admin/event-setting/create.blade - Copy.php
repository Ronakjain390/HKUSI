...
<div class="container-xxl flex-grow-1 container-p-y">
    {!! Form::open(array('route' => 'admin.event-setting.store','method'=>'POST','class'=>'edit-form','autocomplete' => 'off','files' =>true,'id'=>'form-upload')) !!}
    ...
    $(document).ready(function() {
        ...
        $("#form-upload").validate({
            ...
            messages: {
                ...
                main_image: {
                    required: "Please select a thamb image",
                },
                "images[]": {
             ...
             $.ajax({
                ...
                data: {
                 ...
                 success: function(data){
                     ...
                     var selectOpt = '<div class="basic-details"><h6 class="card-heading">Programme</h6> </div><div class="table-details select-table-custom" >
					 <table class="table"><tbody><tr><th class="t-basic">Programme</th><td >
					 <select class="form-control form-select programmeselect" name="programme_id[]" multiple multiselect-search="true" multiselect-select-all="true">';
