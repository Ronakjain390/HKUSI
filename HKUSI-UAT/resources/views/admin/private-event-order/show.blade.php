        ...
        <table class="table">
            <tbody>
                ...
                <tr>
                    ...
                    <td>@if(isset($eventInfo->start_time) && !empty($eventInfo->start_time)) {{date('H:i',$eventInfo->start_time)}} @endif</td>
                </tr>

                <tr>
                    <th class="t-basic">End Time </th>
                    <td> @if(isset($eventInfo->end_time) && !empty($eventInfo->end_time)) {{date('H:i',$eventInfo->end_time)}} @endif</td>
                </tr>
                ...
                <tr>
                    ...
                    <td>@if(isset($bookingInfo->event_group) && !empty($bookingInfo->event_group)) {{$bookingInfo->event_group}} @else N/A @endif</td>
                </tr>

                <tr>
                    <th class="t-basic">Actual Check-in Date </th>
                   <td> @if(isset($bookingInfo->check_in_date) && !empty($bookingInfo->check_in_date)) {{date('Y-m-d',$bookingInfo->check_in_date)}} @else N/A @endif</td>
                </tr>

                <tr>
                    <th class="t-basic">Actual Check-in Time </th>
                   <td> @if(isset($bookingInfo->check_in_time) && !empty($bookingInfo->check_in_time)) {{date('H:i',$bookingInfo->check_in_time)}} @else N/A @endif</td>
                </tr>

                <tr>
                    <th class="t-basic">Check-in Operator </th>
                   <td> @if(isset($bookingInfo->check_operator) && !empty($bookingInfo->check_operator)) {{$bookingInfo->check_operator}} @else N/A @endif</td>
                </tr>

                <tr>
                    <th class="t-basic">Status </th>
                   <td> @if(isset($bookingInfo->event_status) && !empty($bookingInfo->event_status)) @if($bookingInfo->event_status == 'Paid') Enroled and Confirmed @else {{$bookingInfo->event_status}} @endif @endif</td>
                </tr>
