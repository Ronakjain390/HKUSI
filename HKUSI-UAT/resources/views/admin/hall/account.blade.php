        ...
        @csrf
            <div class="form-flex form-password-toggle">
                ...
                <div class="col-input">
                    <div class="input-group input-group-merge">
                        ...
                        <span class="input-group-text cursor-pointer s1"><i toggle="#password-field" class="fa fa-eye toggle" onclick="showPass()"></i></span>
            ...
            <div class="form-check-settings">
                <label class="form-check m-0">
                  <input name="send_email" type="checkbox" class="form-check-input">
