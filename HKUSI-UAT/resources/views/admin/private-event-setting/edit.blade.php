            ...
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="time" name="assembly_start_time"  required class="form-control" placeholder="Assembly Time" @if(isset($eventInfo->assembly_start_time) && !empty($eventInfo->assembly_start_time)) value="{{date('H:i' , $eventInfo->assembly_start_time)}}" @endif></td>
                    </tr>
                    <tr>
                        <th class="t-basic">Assembly End Time</th>
                        <td><input type="time" name="assembly_end_time"  required class="form-control" placeholder="Assembly Time" @if(isset($eventInfo->assembly_end_time) && !empty($eventInfo->assembly_end_time)) value="{{date('H:i' , $eventInfo->assembly_end_time)}}" @endif></td>
                    </tr>
                    <tr>
