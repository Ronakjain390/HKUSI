        ...
        @php  $i=1; @endphp        
            @foreach ($payment as $key => $paymentdata)
                <tr>
                    ...
                    <td>@if(isset($paymentdata->getBookingDetails->status)) {{$paymentdata->getBookingDetails->status}} @endif</td>
                    <td>@if(isset($paymentdata->previous_status) && !empty($paymentdata->previous_status)) {{$paymentdata->previous_status}} @endif</td>
                    ...
                    <td>@if(isset($paymentdata->status) && $paymentdata->status == '1') Confirmed @else Cancelled @endif</td>
