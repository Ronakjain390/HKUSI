...
<div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="profile-tab">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu table-dropdown">
                           <a class="dropdown-item" href="{{route('admin.eventpayment.eventpaymentDetails',[$PaymentInfo->id,'edit'])}}">Edit</a>
    ...
    <div class="profile-page-buttons-section" id="active">
        <a href="{{route('admin.eventpayment.eventpaymentDetails',[$PaymentInfo->id,'show'])}}"  class="btn btn-custom @if((isset($dataType) && !empty($dataType) && $dataType == 'show') || (isset($dataType) && !empty($dataType) && $dataType == 'edit'))  active @endif">
    ...
    @if(isset($dataType) && !empty($dataType) && $dataType == 'edit')
        ...
        @include('admin.event-payment.edit')

    @elseif(isset($dataType) && !empty($dataType) && $dataType == 'show')

        @include('admin.event-payment.show')
