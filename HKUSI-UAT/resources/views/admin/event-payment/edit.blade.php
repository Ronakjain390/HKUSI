{!! Form::model($PaymentInfo, ['method' => 'PATCH','route' => ['admin.eventpayment.update', $PaymentInfo->id],'id' => 'quickForm','autocomplete' => 'off','files' => 'true','class'=>'edit-form']) !!}
    <input type="hidden" name="user_id" value="{{$PaymentInfo->user_id}}">
            ...
            <tbody>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td>{{$PaymentInfo->getyearSilgle->getEventSetting->getYearDetails->year ?? ''}}</td>
                </tr> 
                <tr>
        ...
        <table class="table">
            <tbody>
                ...
                <tr>
                    ...
                    <td>@if(isset($PaymentInfo->getMemberInfos->date_of_birth) && !empty($PaymentInfo->getMemberInfos->date_of_birth)){{$PaymentInfo->getMemberInfos->date_of_birth}}@endif</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>@if(isset($PaymentInfo->getMemberInfos->study_country) && !empty($PaymentInfo->getMemberInfos->study_country)){{$PaymentInfo->getMemberInfos->study_country}}@endif</td>
                </tr>
                {{--<tr>
                    <th class="t-basic">Activation</th>
                    <td>@if(isset($PaymentInfo->status) && !empty($PaymentInfo->status) && $PaymentInfo->status == '1') Yes @else No @endif</td>
                </tr>--}}
            </tbody>
        </table>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <select class="form-control" name="payment_status">
                            ...
                            <option value="PROCESSING" @if(isset($PaymentInfo->payment_status) &&  $PaymentInfo->payment_status == 'PROCESSING') selected @endif> Processing</option>  
                            ...
                            <option value="FAILED" @if(isset($PaymentInfo->payment_status) &&  $PaymentInfo->payment_status == 'FAILED') selected @endif> FAILED</option> 
                        </select>
                    </td>
                </tr>
            </tbody>
