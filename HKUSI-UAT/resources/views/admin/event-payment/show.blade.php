        ...
        <table class="table">
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$PaymentInfo->getMemberInfos->chinese_name ?? 'N/A'}} </td>
                </tr>
                <tr>
                    <th class="t-basic">Gender</th>
                    <td> {{$PaymentInfo->getMemberInfos->gender ?? 'N/A'}} </td>
                </tr>
                <tr>
                    <th class="t-basic">Date Of Birth</th>
                    <td>@if(isset($PaymentInfo->getMemberInfos->date_of_birth) && !empty($PaymentInfo->getMemberInfos->date_of_birth)) {{date('d F Y',$PaymentInfo->getMemberInfos->date_of_birth)}} @else 'N/A' @endif</td>
                </tr>
                <tr>
                    <th class="t-basic">HKID</th>
                    <td> {{$PaymentInfo->getMemberInfos->hkid_card_no ?? 'N/A'}}</td>
                </tr>
                <tr>
                    <th class="t-basic">Passport No.</th>
                    <td>{{$PaymentInfo->getMemberInfos->passport_no ?? 'N/A'}} </td>
                </tr>
                <tr>
