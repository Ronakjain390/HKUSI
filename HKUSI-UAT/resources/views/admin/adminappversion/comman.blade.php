...
@section('content')
	<div class="container-xxl flex-grow-1 container-p-y">
					...
					<div class="profile-tab">
						<div class="dropdown">
							...
							<div class="dropdown-menu table-dropdown">
								<a class="dropdown-item" href="{{ route('admin.adminappversion.versionDetail', [$AppVersionInfo->id, 'edit']) }}">Edit</a>
								{!! Form::open([
								    'method' => 'DELETE',
								    'route' => ['admin.adminappversion.destroy', $AppVersionInfo->id],
		...
		<div class="profile-page-buttons-section" id="active">
			<a href="{{ route('admin.adminappversion.versionDetail', [$AppVersionInfo->id, 'show']) }}"
		...
		@if(isset($dataType) && !empty($dataType) && $dataType == 'edit')
			@include('admin.adminappversion.edit')
		@elseif(isset($dataType) && !empty($dataType) && $dataType == 'show')
			@include('admin.adminappversion.show')
		@endif
