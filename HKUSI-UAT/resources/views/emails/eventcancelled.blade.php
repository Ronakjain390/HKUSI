    ...
    <table style="background-color: #f5faf6;width: 100%;">
        <tr>
            <td style="padding: 20px;">
                ...
                <p>We regret to inform you that the event <b> {{$mailInfo['event_name'] ?? ''}},</b> scheduled for {{date('Y-m-d',$mailInfo['date'])}}, has been cancelled due to unforeseen circumstances or insufficient enrolment. We apologize for any inconvenience this may have caused.</p>
                <p>We will be processing your refund and will notify you of the refund information separately by email.</p>
