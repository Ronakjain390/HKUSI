    ...
    <table style="background-color: #f5faf6;width: 100%;">
        <tr>
            <td style="padding: 20px;">
                ...
                <p>We regret to inform you that your HKU residential hall reservation request has been considered abandoned as the deadline for payment of the accommodation fee has passed.</p>
