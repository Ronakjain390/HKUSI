<div class="container-xxl flex-grow-1 container-p-y">
	<div class="card custom-card">
		...
		<form method="post" action="{{ route('admin.studentappversion.multipleStudentAppVersion') }}">
			{{ csrf_field() }}
						...
						<div class=" fliter-flex d-flex align-items-center">
							...
							<div class="flex-filter-box" wire:ignore>
								...
								<div class="filter-button fx plus-button">
									<a href="{{ route('admin.studentappversion.create') }}">
								...
								@foreach ($language as $key => $programeData)
									<tr>
										...
										<td valign="top" colspan="1" class="dataTables_empty">
											<a href="{{ route('admin.studentappversion.versionDetail', [$programeData->id, 'show']) }}">
										...
										<td valign="top" colspan="1" class="dataTables_empty">
											<div class="dropdown text-center">
												...
												<div class="dropdown-menu table-dropdown">
													<a class="dropdown-item" href="{{ route('admin.studentappversion.versionDetail', [$programeData->id,'edit']) }}">Edit</a>
