<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card custom-card">
                                                    ...
                                                    <div class="fliter-checkbox">
                                                        <div class="filter-dropdown fx">
                                                            <div class="select-custom" wire:ignore>
                                                                <select id="selectpickerBasic" class="selectpicker w-100" data-style="btn-default" wire:model.defer="year" tabindex="null">
                                                                    <option>Select Year</option>
                                                                    @if(isset($halls) && !empty($halls))
                                                                        @foreach($halls as $key => $hallsData)
                                                                            <option>{{$hallsData->year}}</option>
                                                                        @endforeach
                                                                    @endif
                                                                  </select>
                                                            </div>
                                            ...
                                            <div id="accordionStyle1-3" class="accordion-collapse collapse" data-bs-parent="#accordionStyle1">
                                                <div class="accordion-body">
                                                    <div class="fliter-checkbox">
                                                        <div class="filter-dropdown fx">
                                                            <div class="select-custom"  wire:ignore>
                                                                <select id="selectpickerBasic" class="selectpicker w-100" data-style="btn-default" wire:model.defer="unit_price" tabindex="null">
                                                                    <option>Select Unit Price</option>
                                                                    @if(isset($hallsup) && !empty($hallsup))
                                                                        @foreach($hallsup as $key => $hallsupData)
                                                                            <option>{{$hallsupData->unit_price}}</option>
                                                                        @endforeach
                                                                    @endif
                                                                  </select>
                                                            </div>
        ...
        <form method="post" action="{{route('admin.hall.multiplehalldelete')}}">
		{{ csrf_field() }}
                        ...
                        <div class="flex-filter-box" wire:ignore>
                            ...
                            <div class="filter-button fx plus-button">
                                <button type="button" class="btn btn-label-info ">
                                    <a href="{{route('admin.accommondation-setting.create')}}">
                ...
                <table class="dt-select-table table dataTable no-footer dt-checkboxes-select " id="DataTables_Table_3 " aria-describedby="DataTables_Table_3_info ">
                    <thead>
                        <tr>
                            ...
                            <th onclick="return shorting('year','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'year' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'year' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Position: activate to sort column ascending ">Year</th>
                            <th onclick="return shorting('start_date','{{$order_by}}');" class="sorting   @if(isset($order_type) && $order_type == 'start_date' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'start_date' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " s="" aria-label="Email: activate to sort column ascending ">Start Date</th>
                            <th onclick="return shorting('end_date','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'end_date' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'end_date' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="City: activate to sort column ascending ">End Date</th>
                            <th onclick="return shorting('male','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'male' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'male' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Status: activate to sort column ascending ">ACTUAL MALE</th>

                            <th onclick="return shorting('female','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'female' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'female' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Status: activate to sort column ascending ">ACTUAL FEMALE</th>
                            <th onclick="return shorting('total_quotas','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'total_quotas' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'total_quotas' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Date: activate to sort column ascending ">ACTUAL TOTAL QUOTA</th>
                            <th onclick="return shorting('quota_balance','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'quota_balance' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'quota_balance' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Salary: activate to sort column ascending ">MAX MALE QUOTA LIMIT </th>
                            <th onclick="return shorting('quota_balance','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'quota_balance' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'quota_balance' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Salary: activate to sort column ascending ">MAX FEMALE QUOTA LIMIT</th>
                            <th onclick="return shorting('quota_balance','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'quota_balance' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'quota_balance' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Salary: activate to sort column ascending ">MAX QUOTA LIMIT</th>
                            <th onclick="return shorting('application_deadline','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'application_deadline' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'application_deadline' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Status: activate to sort column ascending ">DeadLine</th>
                            <th onclick="return shorting('unit_price','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'unit_price' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'unit_price' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Status: activate to sort column ascending ">Unit Price</th>
                    ...
                    @if(count($members))
                        @php  $i=1; @endphp        
                            @foreach ($members as $key => $memberData)
                                <tr>
                                    <td valign="top" colspan="1" class="dt-checkboxes-cell dt-checkboxes-select-all "><input type="checkbox" name='id[]' class="form-check-input" value="<?php echo $memberData->id; ?>"></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.hallDetails',[$memberData->id,'details'])}}">@if(isset($memberData->created_at) && !empty($memberData->created_at)) {{date('Y-m-d H:i:s' , strtotime($memberData->created_at))}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.hallDetails',[$memberData->id,'details'])}}">@if(!empty($memberData->year)) {{$memberData->year}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.hallDetails',[$memberData->id,'details'])}}">@if(!empty($memberData->start_date)) {{date('Y-m-d',$memberData->start_date)}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.hallDetails',[$memberData->id,'details'])}}">@if(!empty($memberData->end_date))  {{date('Y-m-d',$memberData->end_date)}} @endif</a></td>                                    
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.hallDetails',[$memberData->id,'details'])}}">@if(!empty($memberData->getQuotaDetail->sum('male'))) {{$memberData->getQuotaDetail->sum('male')}} @else 0 @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.hallDetails',[$memberData->id,'details'])}}">@if(!empty($memberData->getQuotaDetail->sum('female'))) {{$memberData->getQuotaDetail->sum('female')}} @else 0 @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.hallDetails',[$memberData->id,'details'])}}">@if(!empty($memberData->getQuotaDetail->sum('total_quotas'))) {{$memberData->getQuotaDetail->sum('total_quotas')}} @else 0 @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.hallDetails',[$memberData->id,'details'])}}">@if(!empty($memberData->getQuotaDetail->sum('male_max_quota'))) {{$memberData->getQuotaDetail->sum('male_max_quota')}} @else 0 @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.hallDetails',[$memberData->id,'details'])}}">@if(!empty($memberData->getQuotaDetail->sum('female_max_quota'))) {{$memberData->getQuotaDetail->sum('female_max_quota')}} @else 0 @endif</a></td>
                                    @php
                                        $malemax = $memberData->getQuotaDetail->sum('male_max_quota');
                                        $femalemax = $memberData->getQuotaDetail->sum('female_max_quota');
                                        $totalmax = $malemax + $femalemax;
                                    @endphp
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.hallDetails',[$memberData->id,'details'])}}">{{$totalmax}}</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.hallDetails',[$memberData->id,'details'])}}">@if(isset($memberData->application_deadline) && !empty($memberData->application_deadline)) {{date('Y-m-d' , $memberData->application_deadline)}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.hallDetails',[$memberData->id,'details'])}}">@if(isset($memberData->unit_price) && !empty($memberData->unit_price)) {{$memberData->unit_price}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty" >
                                        <div class="select_status_filter">                                            
                                            <span class="badge rounded-pill badge-custom  @if(isset($memberData->status) && $memberData->status == '1') green @else gray @endif"> @if($memberData->status=='1') Enabled @else Disabled @endif</span>
                                        </div>                                      
                                    </td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                        ...
                                        <i class="ti ti-dots"></i>
                                            ...
                                            <div class="dropdown-menu table-dropdown">
                                                {{-- <a class="dropdown-item" href="{{route('admin.hallDetails',[$memberData->id,'details'])}}">Show</a> --}}
                                                <a class="dropdown-item" href="{{route('admin.hallDetails',[$memberData->id,'edit'])}}">Edit</a>
                                                <a wire:click="$emit('triggerDelete',{{$memberData->id }})" class="dropdown-item" href="javascript:void(0);">Delete</a>
                                                {{-- @if(isset($memberData->status) && $memberData->status == '0')
                                                <a wire:click="$emit('triggerStatus',{{ $memberData->id }})" class="dropdown-item" href="javascript:void(0);">Enable</a>
                                                @else
                                                <a wire:click="$emit('triggerStatus',{{ $memberData->id }})" class="dropdown-item" href="javascript:void(0);">Disable</a>
                                                @endif
                                                <a class="dropdown-item" href="{{route('admin.quota.quotaDetail',[$memberData->id,'create'])}}">Add</a> --}}
                                            </div>
                                        </div>
                                    </td>
