                            ...
                            @foreach ($payment as $key => $paymentdata)
                                ...
                                <tr>
                                    ...
                                    @else {{date('Y-m-d H:i:s' , strtotime($paymentdata->created_at))}} @endif</a></td>
                                     <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.payments.paymentDetails',[$paymentdata->id,'show'])}}">{{$paymentdata->getBookingDetails->getHallsetting->year ?? ''}}</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    ...
                                    <td valign="top" colspan="1" class="dataTables_empty" >
                                        <div class="select_status_filter">                                            
                                            <span class="badge rounded-pill badge-custom  @if($paymentdata->payment_status=='PAID') green 
                                            ...
                                            @endif"> @if(isset($paymentdata->payment_status) && !empty($paymentdata->payment_status)){{$paymentdata->payment_status}} @else Processing @endif</span>
                                        </div>                                      
                                    </td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
