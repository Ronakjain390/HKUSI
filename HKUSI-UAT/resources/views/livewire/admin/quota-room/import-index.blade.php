                ...
                <table class="dt-select-table table dataTable no-footer dt-checkboxes-select " id="DataTables_Table_3 " aria-describedby="DataTables_Table_3_info ">
                    <thead>
                        <tr>
                            ...
                            <th onclick="return shorting('end_date','{{$order_by}}');" class="sorting   @if(isset($order_type) && $order_type == 'end_date' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'end_date' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " s="" aria-label="Email: activate to sort column ascending ">Reason</th>
                        ...
                        @php  $i=1; @endphp        
                            @foreach ($members as $key => $quotasdata)
                                <tr>
                                    ...
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    @if(isset($quotasdata->room_code) && !empty($quotasdata->room_code)) #{{$quotasdata->room_code}} @endif </td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    @if(isset($quotasdata->college_name) && !empty($quotasdata->college_name)) {{$quotasdata->college_name}} @endif </td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    @if(isset($quotasdata->gender) && !empty($quotasdata->gender)) {{$quotasdata->gender}} @endif </td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
