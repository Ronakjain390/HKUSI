<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card custom-card">
                ...
                <div class="col-sm-12 col-md-7">
                    <div class=" fliter-flex d-flex align-items-center">
                        ...
                        <div class="filter-icon">
                            <a href="javascript:void(0);" class="fliter-roll"><svg width="24" height="25"
                                                    ...
                                                    <div class="form-check  custom-option-basic ">
                                                        <label class="form-check-label custom-option-content"
                                                            ...
                                                            <input name="customRadioTemp" class="form-check-input"
                                                                type="radio" value="" id="customRadioTemp1" checked="">
                                                            <span class="custom-option-header">
                                                                <span class="filter-radio-text">Basic</span>
                                                            </span>
                                                        </label>
                                                    </div>
                                                </div>
                                                            ...
                                                            <span class="custom-option-header">
                                                                <div class="input-calender">
                                                                    <input class="form-control" type="date"
                                                                        placeholder="from " id="html5-date-input">
                                                                </div>
                                                                <div class="input-calender">
                                                                    <input class="form-control" type="date"
                                                                        placeholder="from " id="html5-date-input">
        ...
        <form method="post" action="{{ route('admin.users.multipleusersdelete') }}">
            {{ csrf_field() }}
                    ...
                    <div class="col-sm-12 col-lg-8">
                        <div class="action-buttons d-flex justify-content-end content_start">
                            <div class="data-buttons">
                                <button type="button" wire:click="$set('tabSearch', '3')"
                                    class="flex-button violet @if (isset($tabSearch) && $tabSearch == '3') active @endif">
                                    <sapn>Trash</sapn>
                                    <span>
                            ...
                            <div class="data-buttons">
                                <button type="button" wire:click="$set('tabSearch', '2')"
                                    class="flex-button green @if (isset($tabSearch) && $tabSearch == '2') active @endif">
                                    <sapn>Enabled </sapn>
                                    <span>
                        ...
                        <thead>
                            <tr>
                                <th class="sorting_disabled dt-checkboxes-cell dt-checkboxes-select-all" rowspan="1"
                                    colspan="1" data-col="0" aria-label=""><input type="checkbox"
                                ...
                                <th onclick="return shorting('created_at','{{ $order_by }}');"
                                    ...
                                    Create date</th>
                                <th onclick="return shorting('id','{{ $order_by }}');"
                                    class="sorting @if (isset($order_type) && $order_type == 'id' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'id' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif "
                                    tabindex="0 " aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1"
                                    aria-sort="descending " aria-label="Name: activate to sort column ascending ">
                                    User #</th>
                                <th onclick="return shorting('email','{{ $order_by }}');"
                                    class="sorting   @if (isset($order_type) && $order_type == 'email' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'email' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif "
                                    tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " s=""
                                    aria-label="Email: activate to sort column ascending ">Email Address
                                </th>
                                ...
                                <th onclick="return shorting('gender','{{ $order_by }}');"
                                    ...
                                    tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 "
                                    aria-label="Status: activate to sort column ascending ">gender</th>
                                <th onclick="return shorting('surname','{{ $order_by }}');"
                                    ...
                                    tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 "
                                    aria-label="Status: activate to sort column ascending ">surname</th>
                                ...
                                <th onclick="return shorting('mobile_tel_no','{{ $order_by }}');"
                                    class="sorting  @if (isset($order_type) && $order_type == 'mobile_tel_no' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'mobile_tel_no' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif "
                                    tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 "
                                    aria-label="City: activate to sort column ascending ">Mobile no.</th>
                                <th onclick="return shorting('department','{{ $order_by }}');"
                                    class="sorting  @if (isset($order_type) && $order_type == 'department' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'department' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif "
                                    tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 "
                                    aria-label="Date: activate to sort column ascending ">dept</th>

                                <th class=""
                                    tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 "
                                    aria-label="Role">role</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td valign="top" colspan="1" class="dt-checkboxes-cell dt-checkboxes-select-all"><input
                                        type="checkbox" name='id[]' class="form-check-input" value="{{ $user->id }}">
                                </td>
                                <td valign="top" colspan="1" class="dataTables_empty">
                                    <a @if (isset($tabSearch) && $tabSearch !='3' )
                                        href="{{ route('admin.userDetails', [$user->id, 'show']) }}" @endif>
                                ...
                                <td valign="top" colspan="1" class="dataTables_empty">
                                    <a @if (isset($tabSearch) && $tabSearch !='3' )
                                        href="{{ route('admin.userDetails', [$user->id, 'show']) }}" @endif>
                                        @if (isset($user->given_name) && !empty($user->given_name))
                                        {{ $user->given_name }}
                                        @endif
                                    </a>
                                </td>
                                <td valign="top" colspan="1" class="dataTables_empty">
                                    <a @if (isset($tabSearch) && $tabSearch !='3' )
                                        href="{{ route('admin.userDetails', [$user->id, 'show']) }}" @endif>
                                        @if (isset($user->mobile_tel_no) && !empty($user->mobile_tel_no))
                                        {{ $user->mobile_tel_no }}
                                        @endif
                                    </a>
                                </td>
                                ...
                                <td valign="top" colspan="1" class="dataTables_empty">
                                    <div class="select_status_filter">
                                        <select onchange="return checkstatus(this.value , '{{ $user->id }}')"
                                            name="status"
                                            class="selectstatus w-100 @if (isset($user->status) && $user->status == '1') green @else gray @endif"
                                            data-style="btn-default" tabindex="null" name="status">
                                            <option value="1" @if (isset($user->status) && $user->status == '1')
                                                selected @endif>Enabled
                                            </option>
                                            <option value="0" @if (isset($user->status) && $user->status == '0')
                                    ...
                                    <div class="dropdown text-center">
                                        ...
                                        <div class="dropdown-menu table-dropdown">
                                            ...
                                            <a class="dropdown-item"
                                                href="{{ route('admin.userDetails', [$user->id, 'show']) }}">Show</a>
                                            @endif
                                            @if (isset($tabSearch) && $tabSearch != '3')
                                            <a class="dropdown-item"
                                                href="{{ route('admin.userDetails', [$user->id, 'edit']) }}">Edit</a>
                                            @endif
                                            @if (isset($tabSearch) && $tabSearch == '3')
                                            <button type="button" class="dropdown-item"
                                                wire:click="$emit('triggerForceDelete',{{ $user->id }})">Delete</button>
                                            @endif
                                            <a @if (isset($tabSearch) && $user->deleted_at != '')
                                                wire:click="$emit('triggerRestore',{{ $user->id }})" @else
                                                wire:click="$emit('triggerDelete',{{ $user->id }})" @endif
                                            ...
                                            <a wire:click="$emit('triggerStatus',{{ $user->id }})" class="dropdown-item"
                                        ...
                                        <div class="filter-dropdown">
                                            <div class="btn-group dropup">
                                                ...
                                                <ul class="dropdown-menu custom-dropdown">
                                                    <li><a class="dropdown-item" wire:click="$set('paginate', '20')"
                                                            href="javascript:void(0);">20</a></li>
                                                    <li><a class="dropdown-item" wire:click="$set('paginate', '50')"
                                                            href="javascript:void(0);">50</a></li>
                                                    <li><a class="dropdown-item" wire:click="$set('paginate', '100')"
                                                            href="javascript:void(0);">100</a></li>
                                                    <li><a class="dropdown-item" wire:click="$set('paginate', '500')"
