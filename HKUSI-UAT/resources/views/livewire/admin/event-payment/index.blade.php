<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card custom-card">
        ...
        <form method="post" action="{{route('admin.eventpayment.multipleEventpaymentdelete')}}">
        {{ csrf_field() }}
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-lg-7">
                    <div class="action-buttons d-flex justify-content-end content_start">
                        ...
                        <div class="data-buttons">
                            <button type="button" wire:click="$set('statusfind', 'FAILED')" class="flex-button red @if(isset($statusfind) && $statusfind == 'FAILED') active @endif">
                              <sapn>FAILED</sapn>
                              <span>@if(isset($failed) && $failed > 0) {{$failed}} @else 0 @endif</span>
                          </button>
                        </div>
                    </div>
                </div>
                        ...
                        @php  $i=1; @endphp        
                            @foreach ($payment as $key => $paymentdata)
                                ...
                                <tr>
                                    ...
                                    <a href="{{route('admin.eventpayment.eventpaymentDetails',[$paymentdata->id,'show'])}}">@if(isset($paymentdata->pay_time) && !empty($paymentdata->pay_time)) {{date('Y-m-d H:i:s' , $paymentdata->pay_time)}} 
                                    @else {{date('Y-m-d H:i:s' , strtotime($paymentdata->created_at))}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.eventpayment.eventpaymentDetails',[$paymentdata->id,'show'])}}">{{$paymentdata->getyearSilgle->getEventSetting->getYearDetails->year ?? ''}}</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.eventpayment.eventpaymentDetails',[$paymentdata->id,'show'])}}">@if(isset($paymentdata->id) && !empty($paymentdata->id)) # {{$paymentdata->id}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.eventpayment.eventpaymentDetails',[$paymentdata->id,'show'])}}">@if(isset($paymentdata->application_id) && !empty($paymentdata->application_id)) #{{$paymentdata->application_id}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.eventpayment.eventpaymentDetails',[$paymentdata->id,'show'])}}">@if(isset($paymentdata->payment_id) && !empty($paymentdata->payment_id)) # {{$paymentdata->payment_id}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.eventpayment.eventpaymentDetails',[$paymentdata->id,'show'])}}">@if(isset($paymentdata->transaction_id) && !empty($paymentdata->transaction_id)) #{{$paymentdata->transaction_id}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.eventpayment.eventpaymentDetails',[$paymentdata->id,'show'])}}">@if(isset($paymentdata->order_no) && !empty($paymentdata->order_no)) # {{$paymentdata->order_no}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.eventpayment.eventpaymentDetails',[$paymentdata->id,'show'])}}">@if(isset($paymentdata->service_type) && !empty($paymentdata->service_type)) {{$paymentdata->service_type}} @else N/A @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.eventpayment.eventpaymentDetails',[$paymentdata->id,'show'])}}">@if(isset($paymentdata->amount) && !empty($paymentdata->amount)) ${{$paymentdata->amount}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.eventpayment.eventpaymentDetails',[$paymentdata->id,'show'])}}">@if(isset($paymentdata->payment_method) && !empty($paymentdata->payment_method)) {{$paymentdata->payment_method}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.eventpayment.eventpaymentDetails',[$paymentdata->id,'show'])}}">@if(isset($paymentdata->pay_type) && !empty($paymentdata->pay_type)) {{$paymentdata->pay_type}} @else N/A @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                        <div class="select_status_filter">
                                           <span class="badge rounded-pill badge-custom  @if($paymentdata->payment_status=='PAID') green @elseif($paymentdata->payment_status=='EXPIRED') brown @elseif($paymentdata->payment_status=='') brown @elseif($paymentdata->payment_status=='UATPAID') orange @elseif($paymentdata->payment_status=='CANCELLED') red @elseif($paymentdata->payment_status=='PENDING') brown 
                                           @elseif($paymentdata->payment_status=='PROCESSING') blue 
                                           @elseif($paymentdata->payment_status=='FAILED') red
                                           @elseif($paymentdata->payment_status=='REFUNDED') violet @endif"> @if($paymentdata->payment_status=="PROCESSING") Processing @else {{$paymentdata->payment_status}} @endif</span>
                                        </div>
                                    </td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                        ...
                                        <i class="ti ti-dots"></i>
                                            ...
                                            <div class="dropdown-menu table-dropdown">
                                                ...
                                                <a class="dropdown-item" href="{{route('admin.eventpayment.eventpaymentDetails',[$paymentdata->id,'show'])}}">View</a> 
                                                <a class="dropdown-item" href="{{route('admin.eventpayment.eventpaymentDetails',[$paymentdata->id,'edit'])}}">Edit</a>
