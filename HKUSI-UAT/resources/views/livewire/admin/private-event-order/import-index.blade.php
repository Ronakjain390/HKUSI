{{-- Private Event Order Import Index Created By Akash --}}
                ...
                <table class="dt-select-table table dataTable no-footer dt-checkboxes-select " id="DataTables_Table_3 " aria-describedby="DataTables_Table_3_info ">
                    <thead>
                        <tr>
                            ...
                            <th onclick="return shorting('booking_id','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'booking_id' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'booking_id' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Position: activate to sort column ascending ">Application Id #</th>

                            <th onclick="return shorting('event_id','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'event_id' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'event_id' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Position: activate to sort column ascending ">Event Id #</th>

                            <th onclick="return shorting('event_group','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'event_group' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'event_group' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Position: activate to sort column ascending ">Group</th>

                            <th onclick="return shorting('no_of_seats','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'no_of_seats' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'no_of_seats' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Position: activate to sort column ascending ">No of Ticket(s)</th>

                            <th onclick="return shorting('booking_status','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'booking_status' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'booking_status' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Position: activate to sort column ascending ">Booking Status</th>

                            <th onclick="return shorting('event_status','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'event_status' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'event_status' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Position: activate to sort column ascending ">Event Status</th>
                    ...
                    <tbody>
                    @if(count($privateEvents))
                        @php  $i=1; @endphp        
                            @foreach ($privateEvents as $key => $eventDetail)
                                <tr>
                                    ...
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="javascript:void(0);">@if(isset($eventDetail->application_id) && !empty($eventDetail->application_id))  #{{$eventDetail->application_id}} @endif</a></td>

                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="javascript:void(0);">@if(isset($eventDetail->event_id) && !empty($eventDetail->event_id))  #{{$eventDetail->event_id}} @endif</a></td>

                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="javascript:void(0);">@if(isset($eventDetail->event_group) && !empty($eventDetail->event_group))  {{$eventDetail->event_group}} @endif</a></td>

                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="javascript:void(0);">@if(isset($eventDetail->no_of_seats) && !empty($eventDetail->no_of_seats))  {{$eventDetail->no_of_seats}} @endif</a></td>
                                    
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="javascript:void(0);">@if(isset($eventDetail->booking_status) && !empty($eventDetail->booking_status)) 

                                         {{$eventDetail->booking_status}}  @endif</a></td>

                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="javascript:void(0);">@if(isset($eventDetail->event_status) && !empty($eventDetail->event_status)) 
                                       @if($eventDetail->event_status == 'Paid') Enroled and Confirmed @else {{$eventDetail->event_status}} @endif @endif </a></td>
                    ...
                    <div class="row custom-show-drop-down ">
                        <div class="col-sm-12 col-md-6">
                            <div class="bottom-dropdown">
                                @if(isset($paginate) && !empty($paginate) && $countprivateEvents > $paginate)
                                    ...
                                    <div class="dataTables_info" id="DataTables_Table_3_info " role="status " aria-live="polite ">
                                        <p>Showing <span>@if(isset($page) && !empty($page)) {{$page}} @endif</span> to <span>@if(isset($paginate) && !empty($paginate)) {{$paginate}} @endif</span> of <span>@if(isset($countprivateEvents) && !empty($countprivateEvents)) {{$countprivateEvents}} @endif</span> entries</p>
                                    </div>
                                @endif
                            </div>
                        </div> 
