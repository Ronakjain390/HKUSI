{{-- Private Event Order View Created By Akash --}}
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card custom-card">
                                                    ...
                                                    <div class="form-check  custom-option-basic">
                                                        <span class="custom-option-header">
                                                          <div class="input-calender">
                                                              <input class="form-control" wire:model.defer="inFrom" type="date" placeholder="from ">
                                                          </div>
                                                          <div class="input-calender">
                                                              <input class="form-control" wire:model.defer="inTo" type="date" placeholder="from">
                                                          </div>
                                                        </span> 
                                                      </label>
                                                    </div>
        ...
        <form method="post" action="{{route('admin.private-event-order.multiplePrivateEventOrderDelete')}}">
        {{ csrf_field() }}
                    ...
                    <div class=" fliter-flex d-flex align-items-center">
                        ...
                        <div class="flex-filter-box">
                            ...
                            <div class="filter-button fx">
                                <button type="submit" id="submit" value="Delete All Records" class="btn btn-label-info m-0">Confirm</button>
                            </div>
                            ...
                            <div class="filter-button fx plus-button">
                                <a href="{{route('admin.private-event-order.create')}}" >
                ...
                <div class="col-sm-12 col-lg-7">
                    <div class="action-buttons d-flex justify-content-end content_start">
                        ...
                        <div class="data-buttons">
                            <button type="button" style="height:50px !important;" wire:click="$set('statusfind', 'Paid')" class="flex-button orange @if(isset($statusfind) && $statusfind == 'Paid') active @endif">
                              <sapn>Paid </sapn>
                        ...
                        <div class="data-buttons">
                            <button type="button" style="height:50px !important;" wire:click="$set('statusfind', 'Pending')" class="flex-button brown @if(isset($statusfind) && $statusfind == 'Pending') active @endif">
                              <sapn>Pending </sapn>
                              <span>@if(isset($pending) && $pending > 0) {{$pending}} @else 0 @endif</span>
                          </button>
                        </div> 
                       <div class="data-buttons">
                            <button type="button" style="height:50px !important;" wire:click="$set('statusfind', 'Cancelled')" class="flex-button gray @if(isset($statusfind) && $statusfind == 'Cancelled') active @endif">
                              <sapn>Cancelled </sapn>
                ...
                <table class="dt-select-table table dataTable no-footer dt-checkboxes-select " id="DataTables_Table_3 " aria-describedby="DataTables_Table_3_info ">
                    <thead>
                        <tr>
                            ...
                            <th onclick="return shorting('booking_id','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'booking_id' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'booking_id' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Position: activate to sort column ascending ">Booking #</th>

                            <th onclick="return shorting('event_id','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'event_id' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'event_id' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Position: activate to sort column ascending ">Event #</th>

                            <th onclick="return shorting('application_id','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'application_id' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'application_id' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Position: activate to sort column ascending ">Application #</th>

                            <th onclick="return shorting('event_id','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'event_id' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'event_id' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Position: activate to sort column ascending ">Event Name </th>

                            <th onclick="return shorting('event_id','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'event_id' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'event_id' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Position: activate to sort column ascending ">Group </th>

                            <th onclick="return shorting('event_id','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'event_id' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'event_id' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Position: activate to sort column ascending ">Date </th>
                    ...
                    @if(count($eventData))
                        @php  $i=1; @endphp        
                            @foreach ($eventData as $key => $eventDetail)
                                <tr>
                                    <td valign="top" colspan="1" class="dt-checkboxes-cell dt-checkboxes-select-all "><input class="form-check-input " type="checkbox" name='id[]' value="{{$eventDetail->id}}"></td>

                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.privateEventOrderDetail',[$eventDetail->id,'show'])}}">@if(isset($eventDetail->created_at) && !empty($eventDetail->created_at)) {{date('Y-m-d,  H:i:s' , strtotime($eventDetail->created_at))}} @endif</a></td>
                                    
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.privateEventOrderDetail',[$eventDetail->id,'show'])}}">@if(isset($eventDetail->booking_id ) && !empty($eventDetail->booking_id )) #{{$eventDetail->booking_id }} @endif</a></td>

                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.privateEventOrderDetail',[$eventDetail->id,'show'])}}">@if(isset($eventDetail->event_id ) && !empty($eventDetail->event_id )) #{{$eventDetail->event_id }} @endif</a></td>

                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.privateEventOrderDetail',[$eventDetail->id,'show'])}}">@if(isset($eventDetail->application_id) && !empty($eventDetail->application_id)) #{{  $eventDetail->application_id }} @else N/A @endif</a></td>


                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.privateEventOrderDetail',[$eventDetail->id,'show'])}}">@if(isset($eventDetail->getEventDetails) && !empty($eventDetail->getEventDetails)) {{ $eventDetail->getEventDetails->event_name }} @else N/A @endif</a></td>

                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.privateEventOrderDetail',[$eventDetail->id,'show'])}}">@if(isset($eventDetail->event_group) && !empty($eventDetail->event_group)) {{ $eventDetail->event_group }} @else N/A @endif</a></td>

                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.privateEventOrderDetail',[$eventDetail->id,'show'])}}">@if(isset($eventDetail->getEventDetails) && !empty($eventDetail->getEventDetails)) {{date( 'Y-m-d' , $eventDetail->getEventDetails->date)}} @else N/A @endif</a></td>


                                    <td valign="top" colspan="1" class="dataTables_empty" >
                                        <div class="select_status_filter">                                            
                                            <span class="badge rounded-pill badge-custom  @if($eventDetail->booking_status=='Pending') brown @elseif($eventDetail->booking_status=='Cancelled') gray @elseif($eventDetail->booking_status=='Paid') orange @endif" style="width: 100%;"> @if(isset($eventDetail->booking_status) && !empty($eventDetail->booking_status)){{$eventDetail->booking_status}}  @endif</span>
                                        </div>                                      
                                    </td>
                                    {{-- Private Event Order change by vinod --}}
                                    <!-- <td valign="top" colspan="1" class="dataTables_empty">
                                        <div class="dropdown text-center">
                                            ...
                                            <div class="dropdown-menu table-dropdown">
                                                <a class="dropdown-item" href="{{route('admin.privateEventOrderDetail',[$eventDetail->id,'edit'])}}">Edit</a>
                                                <a class="dropdown-item" href="{{route('admin.privateEventOrderDetail',[$eventDetail->id,'show'])}}">View</a>
                                                <a wire:click="$emit('triggerDelete',{{$eventDetail->id }})" class="dropdown-item" href="javascript:void(0);">Delete</a>
                                            </div>
                                        </div>
                                    </td> -->
