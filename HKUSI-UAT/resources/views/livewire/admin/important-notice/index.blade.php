<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card custom-card">
        ...
        <form method="post" action="{{route('admin.importantnotice.multipleimportentnoticedelete')}}">
        {{ csrf_field() }}
                    ...
                    <div class=" fliter-flex d-flex align-items-center">
                        ...
                        <div class="flex-filter-box" wire:ignore>
                            ...
                            <div class="filter-button fx plus-button">
                                <a href="{{route('admin.importantnotice.create')}}">
                ...
                <table class="dt-select-table table dataTable no-footer dt-checkboxes-select " id="DataTables_Table_3 " aria-describedby="DataTables_Table_3_info ">
                    <thead>
                        <tr>
                            ...
                            <th onclick="return shorting('title','{{$order_by}}');" class="sorting   @if(isset($order_type) && $order_type == 'title' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'title' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " s="" aria-label="Programe title: activate to sort column ascending ">Name</th>
                        ...
                        @if(count($programme))
                            @foreach($programme as $key => $countrydata)
                                <tr>
                                    ...
                                    <a href="{{route('admin.importantnoticesetting',[$countrydata->id,'show'])}}">@if(isset($countrydata->created_at) && !empty($countrydata->created_at)) {{date('Y-m-d H:i:s' , strtotime($countrydata->created_at))}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.importantnoticesetting',[$countrydata->id,'show'])}}">@if(isset($countrydata->title) && !empty($countrydata->title)) {{$countrydata->title}} @endif</a></td>
                                      <td valign="top" colspan="1" class="dataTables_empty" >
                                    ...
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                        <div class="dropdown text-center">
                                            ...
                                            <div class="dropdown-menu table-dropdown">
                                                <a class="dropdown-item" href="{{route('admin.importantnotice.edit',$countrydata->id)}}">Edit</a>
