                    ...
                    <div class=" fliter-flex d-flex align-items-center">
                        ...
                        <div class="flex-filter-box" wire:ignore>
                            ...
                            <div class="filter-button fx plus-button">
                                <a href="{{route('admin.quota.quotaDetail',[$hall_setting_id,'create'])}}">
                ...
                <table class="dt-select-table table dataTable no-footer dt-checkboxes-select " id="DataTables_Table_3 " aria-describedby="DataTables_Table_3_info ">
                    <thead>
                        <tr>
                            ...
                            <th onclick="return shorting('id','{{$order_by}}');" class="sorting @if(isset($order_type) && $order_type == 'id' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'id' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0 " aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1" aria-sort="descending " aria-label="Name: activate to sort column ascending ">Quota #</th>
                            ...
                            <th onclick="return shorting('male','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'male' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'male' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Salary: activate to sort column ascending ">Actual Male </th>
                            ...
                            <th onclick="return shorting('total_quotas','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'total_quotas' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'total_quotas' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="City: activate to sort column ascending ">Actual Total Quota </th>

                            <th onclick="return shorting('male_max_quota','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'male_max_quota' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'male_max_quota' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Status: activate to sort column ascending ">Max Male Quota Limit </th>

                            <th onclick="return shorting('female_max_quota','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'female_max_quota' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'female_max_quota' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Status: activate to sort column ascending ">Max Female Quota Limit </th>
                            <th onclick="return shorting('quota_balance','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'quota_balance' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'quota_balance' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Date: activate to sort column ascending ">Max Quota Limit Balance</th>
                            <th onclick="return shorting('status','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'status' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'status' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Status: activate to sort column ascending ">Staus</th>
                        ...
                        @php  $i=1; @endphp        
                            @foreach ($quotas as $key => $quotasdata)
                                <tr>
                                    ...
                                    <a href="{{route('admin.quota.quotaDetail',[$quotasdata->id,'show'])}}">@if(isset($quotasdata->created_at) && !empty($quotasdata->created_at)) {{date('Y-m-d H:i:s' , strtotime($quotasdata->created_at))}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.quota.quotaDetail',[$quotasdata->id,'show'])}}">@if(isset($quotasdata->id) && !empty($quotasdata->id)) # {{$quotasdata->id}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.quota.quotaDetail',[$quotasdata->id,'show'])}}">@if(isset($quotasdata->start_date) && !empty($quotasdata->start_date)) {{date('Y-m-d',$quotasdata->start_date)}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.quota.quotaDetail',[$quotasdata->id,'show'])}}">@if(isset($quotasdata->end_date) && !empty($quotasdata->end_date)) {{date('Y-m-d',$quotasdata->end_date)}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.quota.quotaDetail',[$quotasdata->id,'show'])}}">@if(isset($quotasdata->male)) {{$quotasdata->male}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.quota.quotaDetail',[$quotasdata->id,'show'])}}">@if(isset($quotasdata->female)) {{$quotasdata->female}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.quota.quotaDetail',[$quotasdata->id,'show'])}}">@if(isset($quotasdata->total_quotas) && $quotasdata->total_quotas!='') {{$quotasdata->total_quotas}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.quota.quotaDetail',[$quotasdata->id,'show'])}}">
                                        @php  
                                            $maleQuotaBalance = $femaleQuotaBalance = $QuotaBalance= $balance = $maleQuota = $femaleQuota = $i = $k= $t = 0;
                                            if(isset($quotasdata->male_max_quota) && $quotasdata->male_max_quota!=''){
                                                $maleQuota = $quotasdata->male_max_quota;
                                            }
                                            if(isset($quotasdata->female_max_quota) && $quotasdata->female_max_quota!=''){
                                                $femaleQuota = $quotasdata->female_max_quota;
                                            }
                                            if(isset($quotasdata->female_max_quota) && $quotasdata->female_max_quota!='' && isset($quotasdata->male_max_quota) && $quotasdata->male_max_quota!=''){
                                                $balance = $quotasdata->female_max_quota + $quotasdata->male_max_quota;
                                            }
                                            if(isset($quotasdata->getHallBookinInfos) && count($quotasdata->getHallBookinInfos)){
                                                foreach($quotasdata->getHallBookinInfos as $bookingInfos){
                                        ...
                                        @endphp
                                        @if(isset($quotasdata->male_max_quota) && $quotasdata->male_max_quota!='') {{$quotasdata->male_max_quota}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.quota.quotaDetail',[$quotasdata->id,'show'])}}">@if(isset($quotasdata->female_max_quota) && $quotasdata->female_max_quota!='') {{$quotasdata->female_max_quota}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                        <a href="{{route('admin.quota.quotaDetail',[$quotasdata->id,'show'])}}">
                                       {{$QuotaBalance}}</a>
                                    </td>
                                    ...
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                        ...
                                        <i class="ti ti-dots"></i>
                                            ...
                                            <div class="dropdown-menu table-dropdown">
                                                <a class="dropdown-item" href="{{route('admin.quota.quotaDetail',[$quotasdata->id,'edit'])}}">Edit</a>
...
@push('foorterscript')
  <script type="text/javascript">
      ...
      function checkstatusQuota(value,id) {
        Swal.fire({
            title: "Are you sure?",
