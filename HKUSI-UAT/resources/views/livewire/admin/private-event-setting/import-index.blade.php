{{-- Private Event Setting Import Index Created By Akash --}}
                ...
                <table class="dt-select-table table dataTable no-footer dt-checkboxes-select " id="DataTables_Table_3 " aria-describedby="DataTables_Table_3_info ">
                    <thead>
                        <tr>
                            ...
                            <th onclick="return shorting('application_deadline','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'application_deadline' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'application_deadline' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Status: activate to sort column ascending ">Reason</th>
                    ...
                    @if(count($members))
                        @php  $i=1; @endphp        
                            @foreach ($members as $key => $eventDetail)
                                <tr>
                                    ...
                                    <a href="javascript:void(0);">@if(isset($eventDetail->created_at) && !empty($eventDetail->created_at)) {{date('Y-m-d  H:i:s' , strtotime($eventDetail->created_at))}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="javascript:void(0);">@if(isset($eventDetail->id) && !empty($eventDetail->id)) # {{$eventDetail->id}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="javascript:void(0);">@if(isset($eventDetail->event_name) && !empty($eventDetail->event_name))  {{$eventDetail->event_name}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="javascript:void(0);">@if(isset($eventDetail->date) && !empty($eventDetail->date)) {{date( 'Y-m-d' , $eventDetail->date)}} @else N/A @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="javascript:void(0);" >@if(isset($eventDetail->start_time) && !empty($eventDetail->start_time)) {{date('H:i',$eventDetail->start_time)}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="javascript:void(0);" >@if(isset($eventDetail->end_time) && !empty($eventDetail->end_time)) {{date('H:i',$eventDetail->end_time)}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    ...
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="javascript:void(0);">@if(isset($eventDetail->application_deadline) && !empty($eventDetail->application_deadline)) {{date( 'Y-m-d' , $eventDetail->application_deadline)}} @else N/A @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="javascript:void(0);">@if(isset($eventDetail->reason) && !empty($eventDetail->reason)) {{$eventDetail->reason}} @else N/A @endif</a></td>
                                  <td valign="top" colspan="1" class="dataTables_empty"><span  class="badge rounded-pill badge-custom @if(isset($eventDetail->status) && $eventDetail->status == '1') green @else gray @endif">@if(isset($eventDetail->status) && $eventDetail->status == '1') Success @else Failed @endif</span></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
