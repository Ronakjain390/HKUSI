{{-- Private Event Setting View Created By Akash --}}
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card custom-card">
        ...
        <form method="post" action="{{route('admin.private-event-setting.multiplePrivateEventDelete')}}">
        {{ csrf_field() }}
                    ...
                    <div class=" fliter-flex d-flex align-items-center">
                        ...
                        <div class="flex-filter-box">
                            ...
                            <div class="filter-button fx plus-button">
                                <a href="{{route('admin.private-event-setting.create')}}" >
                        ...
                        @php  $i=1; @endphp        
                            @foreach ($eventData as $key => $eventDetail)
                                <tr>
                                    ...
                                    <a href="{{route('admin.privateEventSettingDetails',[$eventDetail->id,'show'])}}">@if(isset($eventDetail->created_at) && !empty($eventDetail->created_at)) {{date('Y-m-d  H:i:s' , strtotime($eventDetail->created_at))}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.privateEventSettingDetails',[$eventDetail->id,'show'])}}">{{$eventDetail->getYearDetails->year ?? 'N/A'}}</a></td><td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.privateEventSettingDetails',[$eventDetail->id,'show'])}}">@if(isset($eventDetail->id) && !empty($eventDetail->id)) # {{$eventDetail->id}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.privateEventSettingDetails',[$eventDetail->id,'show'])}}">@if(isset($eventDetail->event_name) && !empty($eventDetail->event_name))  {{$eventDetail->event_name}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.privateEventSettingDetails',[$eventDetail->id,'show'])}}">@if(isset($eventDetail->date) && !empty($eventDetail->date)) {{date( 'Y-m-d' , $eventDetail->date)}} @else N/A @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.privateEventSettingDetails',[$eventDetail->id,'show'])}}" >@if(isset($eventDetail->start_time) && !empty($eventDetail->start_time)) {{date('H:i',$eventDetail->start_time)}} @endif</a></td>
									<td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.privateEventSettingDetails',[$eventDetail->id,'show'])}}" >@if(isset($eventDetail->end_time) && !empty($eventDetail->end_time)) {{date('H:i',$eventDetail->end_time)}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                        <a href="{{route('admin.privateEventSettingDetails',[$eventDetail->id,'show'])}}">
                                    ...
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.privateEventSettingDetails',[$eventDetail->id,'show'])}}">@if(isset($eventDetail->application_deadline) && !empty($eventDetail->application_deadline)) {{date( 'Y-m-d' , $eventDetail->application_deadline)}} @else N/A @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty" >
                                    ...
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                        <div class="dropdown text-center">
                                            ...
                                            <div class="dropdown-menu table-dropdown">
                                                <a class="dropdown-item" href="{{route('admin.privateEventSettingDetails',[$eventDetail->id,'edit'])}}">Edit</a>
                                                <a class="dropdown-item" href="{{route('admin.privateEventSettingDetails',[$eventDetail->id,'show'])}}">View</a>
