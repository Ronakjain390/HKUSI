<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card custom-card">
        <div class="filter-card">
         ...
         <form method="post" action="{{route('admin.import.multipleAction')}}">
        {{ csrf_field() }}
        <input type="hidden" name="select_type" id='myhidden' value='Delete'>
                    ...
                    <thead>
                        <tr>
                           <th class="sorting_disabled dt-checkboxes-cell dt-checkboxes-select-all " rowspan="1 " colspan="1 " data-col="0 " aria-label=" " ><input type="checkbox" class="form-check-input " id="checkAll"></th>
                            <th onclick="return shorting('created_at','{{$order_by}}');" class="sorting @if(isset($order_type) && $order_type == 'created_at' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'created_at' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0 " aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1" aria-sort="descending " aria-label="Create Date: activate to sort column ascending ">CREATE DATE</th>
                            <th onclick="return shorting('id','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'id' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'id' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Import: activate to sort column ascending ">Import #</th>
                            <th onclick="return shorting('type','{{$order_by}}');" class="sorting   @if(isset($order_type) && $order_type == 'type' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'type' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " s="" aria-label="Type: activate to sort column ascending ">Type</th>
                            <th onclick="return shorting('name','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'name' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'name' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="City: activate to sort column ascending ">Admin User</th>
                            <th onclick="return shorting('name','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'name' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'name' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="City: activate to sort column ascending ">Records</th>
                            <th onclick="return shorting('year','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'year' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'year' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="City: activate to sort column ascending ">Year</th>
                    ...
                    <tbody>
                        @if(count($import))
                            @foreach($import as $key => $importData)
                                <tr>
                                    <td valign="top" colspan="1" class="dt-checkboxes-cell dt-checkboxes-select-all "><input type="checkbox" name='id[]' class="form-check-input" value="{{$importData->id}}"></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.import.importDetail',[$importData->id,'detail'])}}">@if(isset($importData->created_at) && !empty($importData->created_at)) {{date('Y-m-d  H:i:s' , strtotime($importData->created_at))}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.import.importDetail',[$importData->id,'detail'])}}">@if(isset($importData->id) && !empty($importData->id)) #{{$importData->id}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.import.importDetail',[$importData->id,'detail'])}}">@if(isset($importData->type) && !empty($importData->type)) {{$importData->type}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.import.importDetail',[$importData->id,'detail'])}}">@if(isset($importData->getUserDetail->name) && !empty($importData->getUserDetail->name)) {{$importData->getUserDetail->name}} @endif</a></td>
                                    
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                        <a href="{{route('admin.import.importDetail',[$importData->id,'detail'])}}"> 
                                            @if(isset($importData->getImportProgramReportDetail) && !empty($importData->getImportProgramReportDetail) && $importData->type == 'Programme')
                                                {{$importData->getImportProgramReportDetail->count()}}
                                            @elseif(isset($importData->getImportMemberReportDetail) && !empty($importData->getImportMemberReportDetail) && $importData->type == 'Memeber')
                                                {{$importData->getImportMemberReportDetail->count()}}
                                            @elseif(isset($importData->getImportMemberReportDetail) && !empty($importData->getImportMemberReportDetail) && $importData->type == 'Event')
                                                {{$importData->getImportEventReportDetail->count()}}

                                            @elseif(isset($importData->getImportPrivateEventReportDetail) && !empty($importData->getImportPrivateEventReportDetail) && $importData->type == 'Private Event Booking')
                                                {{$importData->getImportPrivateEventReportDetail->count()}}

                                            @elseif(isset($importData->getImportPrivateEventSettingReportDetail) && !empty($importData->getImportPrivateEventSettingReportDetail) && $importData->type == 'Private Event')
                                                {{$importData->getImportPrivateEventSettingReportDetail->count()}}
                                                
                                            @elseif(isset($importData->getImportHallDetail) && !empty($importData->getImportHallDetail) && $importData->type == 'Hall')
                                                {{$importData->getImportHallDetail->count()}}
                                            @elseif(isset($importData->getImportRoomDetail) && !empty($importData->getImportRoomDetail) && $importData->type == 'Room')
                                                {{$importData->getImportRoomDetail->count()}}

                                            @elseif(isset($importData->getImportHotelDetail) && !empty($importData->getImportHotelDetail) && $importData->type == 'Hotel')
                                                {{$importData->getImportHotelDetail->count()}}
                                            @endif
                                        </a>
                                    </td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.import.importDetail',[$importData->id,'detail'])}}">@if(isset($importData->getHallSetting->year) && !empty($importData->getHallSetting->year)) {{$importData->getHallSetting->year}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                        <span class="badge rounded-pill badge-custom @if(isset($importData->status) && $importData->status == '1') green @else gray @endif">@if(isset($importData->status) && $importData->status == '1') Success  @else Failed @endif</span>
                                    </td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                        <div class="dropdown text-center">
                                            ...
                                            <div class="dropdown-menu table-dropdown">
                                                <a class="dropdown-item" href="{{route('admin.import.importDetail',[$importData->id,'detail'])}}">View</a>
                                                <a wire:click="$emit('triggerDelete',{{$importData->id }})" class="dropdown-item" href="javascript:void(0);">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                    ...
                    <div class="row custom-show-drop-down ">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <nav aria-label="Page navigation ">
                                {{$import->links('admin.includes.comman')}}
                            </nav>
                        </div> 
                    </div>
                </div>
