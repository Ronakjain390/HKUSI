...
<form class="edit-form">
    <div class="card custom-card profile-details import-page">
                ...
                <tbody>
                    @if(isset($databaseFields) && count($databaseFields))
                        @foreach($databaseFields as $key => $databaseFieldsData)
                            @if($databaseFieldsData!='id' && $databaseFieldsData!='user_id' && $databaseFieldsData!='import_data_info_id' && $databaseFieldsData!='image_bank_id' && $databaseFieldsData!='status' && $databaseFieldsData!='deleted_at' && $databaseFieldsData!='created_at' && $databaseFieldsData!='updated_at')
                                <tr>
        ...
        <div class="form-btn import-btn text-end">
            <button type="button" wire:click.prevent="importSecond()" class="btn action-btn" wire:loading="importThird()" wire.target="importFourth()">Run</button>
        </div>
    </div>
</form>
