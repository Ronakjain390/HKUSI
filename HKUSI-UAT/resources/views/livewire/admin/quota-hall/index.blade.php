<div class="flex-grow-1 container-p-y">
    <div class="card custom-card">
        ...
        <form method="post" action="{{route('admin.quota-hall.multiplequotahalldelete')}}">
		{{ csrf_field() }}
                    ...
                    <div class=" fliter-flex d-flex align-items-center">
                        ...
                        <div class="flex-filter-box" wire:ignore>
                            <div class="filter-dropdown fx">
                                <div class="select-custom">
                                    <select id="selectpickerBasic" class="selectpicker w-100" data-style="btn-default" tabindex="null" onchange="return selectDataAction(event)">
                                        <option value="enable">Release</option>
                            ...
                            <div class="filter-button fx plus-button">
                                @if(Request::segment(2) === 'quota')
                                    <a href="{{route('admin.quotahall.quotahallDetails',[$quotas_id,'create'])}}">
                ...
                <div class="col-sm-12 col-lg-8">
                    <div class="action-buttons d-flex justify-content-end content_start">
                        <div class="data-buttons">
                            <button type="button" wire:click="$set('is_import', '1')" class="flex-button green @if(isset($is_import) && $is_import == '1') active @endif">
                              <sapn>Released </sapn>
                              <span>@if(isset($totalCompleted) && $totalCompleted > 0) {{$totalCompleted}} @else 0 @endif</span>
                          </button>
                        </div>
                        <div class="data-buttons">
                            <button type="button" wire:click="$set('is_import', '0')" class="flex-button gray @if(isset($is_import) && $is_import == '0') active @endif">
                              <sapn>Pending</sapn>
            ...
            <div id="DataTables_Table_3_wrapper " class="dataTables_wrapper dt-bootstrap5 no-footer ">
                <table class="dt-select-table table dataTable no-footer dt-checkboxes-select " id="DataTables_Table_3 " aria-describedby="DataTables_Table_3_info ">
                    <thead>
                        ...
                        <th onclick="return shorting('id','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'id' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'id' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Position: activate to sort column ascending ">Hall #</th>
                         <th onclick="return shorting('id','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'id' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'id' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Position: activate to sort column ascending ">quota #</th>
                            ...
                            <th onclick="return shorting('total_quotas','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'male' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'male' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Salary: activate to sort column ascending ">Total Qouta</th>
                            <th onclick="return shorting('college_name','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'college_name' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'college_name' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3" rowspan="1 " colspan="1 " aria-label="Status: activate to sort column ascending ">Hall/Collage</th>
                            <th onclick="return shorting('address','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'address' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'address' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Status: activate to sort column ascending ">Address</th>
                            <th onclick="return shorting('room_type','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'room_type' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'room_type' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Status: activate to sort column ascending ">Room Type</th>
                            <th onclick="return shorting('check_in_date','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'check_in_date' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'check_in_date' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Status: activate to sort column ascending ">In Date</th>
                            <th onclick="return shorting('check_in_time','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'check_in_time' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'check_in_time' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Status: activate to sort column ascending ">In Time</th>
                            <th onclick="return shorting('check_out_date','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'check_out_date' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'check_out_date' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Status: activate to sort column ascending ">Out Date</th>
                            <th onclick="return shorting('check_out_time','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'check_out_time' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'check_out_time' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Status: activate to sort column ascending ">Out Time</th>
                            <th onclick="return shorting('pdf','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'pdf' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'pdf' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Status: activate to sort column ascending ">PDF</th>
                        ...
                        @php  $i=1; @endphp     
                            @foreach ($quotas as $key => $quotasdata)
                                <tr>
                                    ...
                                    <a href="{{route('admin.quotahall.quotahallDetails',[$quotasdata->id,'show'])}}">@if(isset($quotasdata->created_at) && !empty($quotasdata->created_at)) {{date('Y-m-d H:i:s' , strtotime($quotasdata->created_at))}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.quotahall.quotahallDetails',[$quotasdata->id,'show'])}}">@if(isset($quotasdata->id) && !empty($quotasdata->id)) # {{$quotasdata->id}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.quotahall.quotahallDetails',[$quotasdata->id,'show'])}}">@if(isset($quotasdata->quota_id) && !empty($quotasdata->quota_id)) # {{$quotasdata->quota_id}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.quotahall.quotahallDetails',[$quotasdata->id,'show'])}}">@if(isset($quotasdata->start_date) && !empty($quotasdata->start_date)) {{date('Y-m-d',$quotasdata->start_date)}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.quotahall.quotahallDetails',[$quotasdata->id,'show'])}}">@if(isset($quotasdata->end_date) && !empty($quotasdata->end_date)) {{date('Y-m-d',$quotasdata->end_date)}} @endif</a></td>
                                     <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.quotahall.quotahallDetails',[$quotasdata->id,'show'])}}">@if(isset($quotasdata->male)) {{$quotasdata->male}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.quotahall.quotahallDetails',[$quotasdata->id,'show'])}}">@if(isset($quotasdata->female)) {{$quotasdata->female}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.quotahall.quotahallDetails',[$quotasdata->id,'show'])}}">@if(isset($quotasdata->total_quotas)) {{$quotasdata->total_quotas}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.quotahall.quotahallDetails',[$quotasdata->id,'show'])}}">@if(isset($quotasdata->college_name) && !empty($quotasdata->college_name)) {{$quotasdata->college_name}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.quotahall.quotahallDetails',[$quotasdata->id,'show'])}}">@if(isset($quotasdata->address) && !empty($quotasdata->address)) {{$quotasdata->address}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.quotahall.quotahallDetails',[$quotasdata->id,'show'])}}">@if(isset($quotasdata->room_type) && !empty($quotasdata->room_type)) {{$quotasdata->room_type}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.quotahall.quotahallDetails',[$quotasdata->id,'show'])}}">@if(isset($quotasdata->check_in_date) && !empty($quotasdata->check_in_date)) {{date('Y-m-d',$quotasdata->check_in_date)}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.quotahall.quotahallDetails',[$quotasdata->id,'show'])}}">@if(isset($quotasdata->check_in_time) && !empty($quotasdata->check_in_time)) {{date('H:i',$quotasdata->check_in_time)}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.quotahall.quotahallDetails',[$quotasdata->id,'show'])}}">@if(isset($quotasdata->check_out_date) && !empty($quotasdata->check_out_date)) {{date('Y-m-d',$quotasdata->check_out_date)}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.quotahall.quotahallDetails',[$quotasdata->id,'show'])}}">@if(isset($quotasdata->check_out_time) && !empty($quotasdata->check_out_time)) {{date('H:i',$quotasdata->check_out_time)}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    @if(isset($quotasdata->pdf) && !empty($quotasdata->pdf) && Storage::disk($DISK_NAME)->exists($quotasdata->pdf))
                                    <a style="color:blue;"  target="_blank" href="{{asset(Storage::url($quotasdata->pdf))}}">Download</a>@endif</td>
                                    <td valign="top" colspan="1" class="dataTables_empty" >
                                        <div class="select_status_filter">                                            
                                            <span class="badge rounded-pill badge-custom @if(isset($quotasdata->status) && $quotasdata->status == '1') green @else gray @endif">@if($quotasdata->status==1)Released @else Pending @endif </span>
                                        </div>                                      
                                    </td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                        ...
                                        <i class="ti ti-dots"></i>
                                            ...
                                            <div class="dropdown-menu table-dropdown">
                                                <a class="dropdown-item" href="{{route('admin.quotahall.quotahallDetails',[$quotasdata->id,'edit'])}}">Edit</a>
                                                <a wire:click="$emit('triggerDelete',{{$quotasdata->id }})" class="dropdown-item" href="javascript:void(0);">Delete</a>
                                                 <a  class="dropdown-item" href="{{route('admin.room.roomDetail',[$quotasdata->id,'create'])}}">Add Room</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
...
@push('foorterscript')
  <script type="text/javascript">
      document.addEventListener('DOMContentLoaded', function (e) {
        ...
        function checkstatusQuotaHall(value,id) {
            Swal.fire({
                title: "Are you sure?",
