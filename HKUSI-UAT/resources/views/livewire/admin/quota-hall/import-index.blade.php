                ...
                <table class="dt-select-table table dataTable no-footer dt-checkboxes-select " id="DataTables_Table_3 " aria-describedby="DataTables_Table_3_info ">
                    <thead>
                        ...
                        <th onclick="return shorting('id','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'id' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'id' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Position: activate to sort column ascending ">Hall #</th>
                            ...
                            <th onclick="return shorting('check_in_date','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'check_in_date' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'check_in_date' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Status: activate to sort column ascending ">In Time</th>
                            <th onclick="return shorting('check_in_date','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'check_in_date' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'check_in_date' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Status: activate to sort column ascending ">Out Date</th>
                            <th onclick="return shorting('check_in_time','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'check_in_time' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'check_in_time' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Status: activate to sort column ascending ">Out Time</th>
                            <th onclick="return shorting('check_in_time','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'check_in_time' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'check_in_time' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Status: activate to sort column ascending ">Room Key Location</th>
                            <th onclick="return shorting('pdf','{{$order_by}}');" class="sorting  @if(isset($order_type) && $order_type == 'pdf' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'pdf' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " aria-label="Status: activate to sort column ascending ">Reason</th>
                    ...
                    @if(count($members))
                        @php  $i=1; @endphp        
                            @foreach ($members as $key => $quotasdata)
                                <tr>
                                    ...
                                    @if(isset($quotasdata->created_at) && !empty($quotasdata->created_at)) {{date('Y-m-d H:i:s' , strtotime($quotasdata->created_at))}} @endif </td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    @if(isset($quotasdata->id) && !empty($quotasdata->id)) # {{$quotasdata->id}} @endif </td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    @if(isset($quotasdata->start_date) && !empty($quotasdata->start_date)) {{date('Y-m-d',$quotasdata->start_date)}} @endif </td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    @if(isset($quotasdata->end_date) && !empty($quotasdata->end_date)) {{date('Y-m-d',$quotasdata->end_date)}} @endif </td>
                                     <td valign="top" colspan="1" class="dataTables_empty">
                                    @if(isset($quotasdata->male)) {{$quotasdata->male}} @endif </td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    @if(isset($quotasdata->female)) {{$quotasdata->female}} @endif </td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    @if(isset($quotasdata->total_quotas)) {{$quotasdata->total_quotas}} @endif </td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    @if(isset($quotasdata->college_name) && !empty($quotasdata->college_name)) {{$quotasdata->college_name}} @endif </td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    @if(isset($quotasdata->address) && !empty($quotasdata->address)) {{$quotasdata->address}} @endif </td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    @if(isset($quotasdata->room_type) && !empty($quotasdata->room_type)) {{$quotasdata->room_type}} @endif </td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    @if(isset($quotasdata->check_in_date) && !empty($quotasdata->check_in_date)) {{date('Y-m-d',$quotasdata->check_in_date)}} @endif</td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    @if(isset($quotasdata->check_in_time) && !empty($quotasdata->check_in_time)) {{date('H:i',$quotasdata->check_in_time)}} @endif </td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    @if(isset($quotasdata->check_out_date) && !empty($quotasdata->check_out_date)) {{date('Y-m-d',$quotasdata->check_out_date)}} @endif</td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    @if(isset($quotasdata->check_out_time) && !empty($quotasdata->check_out_time)) {{date('H:i',$quotasdata->check_out_time)}} @endif </td> 
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                   {{$quotasdata->room_key_location ?? ''}}</td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    @if(isset($quotasdata->reason) && !empty($quotasdata->reason)) {{$quotasdata->reason}} @endif </td>
                                     <td valign="top" colspan="1" class="dataTables_empty"><span  class="badge rounded-pill badge-custom @if(isset($quotasdata->status) && $quotasdata->status == '1') green @else gray @endif">@if(isset($quotasdata->status) && $quotasdata->status == '1') Success @else Failed @endif</span></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
