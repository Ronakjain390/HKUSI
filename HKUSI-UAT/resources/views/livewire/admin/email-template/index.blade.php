<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card custom-card">
        ...
        <form method="post" action="{{route('admin.email-template.emailtemplatesettingmultiple')}}">
        {{ csrf_field() }}
                        ...
                        @if(count($programme))
                            @foreach($programme as $key => $countrydata)
                                <tr>
                                    ...
                                    <a href="{{route('admin.emailtemplatesetting',[$countrydata->id,'show'])}}">@if(isset($countrydata->created_at) && !empty($countrydata->created_at)) {{date('Y-m-d H:i:s' , strtotime($countrydata->created_at))}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.emailtemplatesetting',[$countrydata->id,'show'])}}">@if(isset($countrydata->title) && !empty($countrydata->title)) {{$countrydata->title}} @endif</a></td>
                                      <td valign="top" colspan="1" class="dataTables_empty" >
                                    ...
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                        <div class="dropdown text-center">
                                            ...
                                            <div class="dropdown-menu table-dropdown">
                                                <a class="dropdown-item" href="{{route('admin.email-template.edit',$countrydata->id)}}">Edit</a>
