                    ...
                    <div class=" fliter-flex d-flex align-items-center">
                        ...
                        <div class="flex-filter-box" wire:ignore>
                            ...
                            <div class="filter-button fx plus-button">
                                <a href="{{route('admin.event-type.create')}}">
                ...
                <table class="dt-select-table table dataTable no-footer dt-checkboxes-select " id="DataTables_Table_3 " aria-describedby="DataTables_Table_3_info ">
                    <thead>
                        <tr>
                            ...
                            <th onclick="return shorting('created_at','{{$order_by}}');" class="sorting @if(isset($order_type) && $order_type == 'created_at' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'created_at' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0 " aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1" aria-sort="descending " aria-label="Name: activate to sort column ascending ">Name</th>
                    ...
                    <tbody>
                        @if(count($eventtype))
                            @foreach($eventtype as $key => $programeData)
                                <tr>
                                    ...
                                    <a href="javascript:void(0);">@if(isset($programeData->created_at) && !empty($programeData->created_at)) {{date('Y-m-d H:i:s' , strtotime($programeData->created_at))}} @endif</a></td>
                                    
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="javascript:void(0);">@if(isset($programeData->name) && !empty($programeData->name)) {{$programeData->name}} @endif</a></td>
                                   <td valign="top" colspan="1" class="dataTables_empty" >
                                        <div class="select_status_filter">                                            
                                            <span class="badge rounded-pill badge-custom  @if($programeData->status=='1') green @else gray @endif"> @if($programeData->status==1) Enable @else Disable   @endif</span>
                                        </div>                                      
                                    </td>                               
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                        <div class="dropdown text-center">
                                            ...
                                            <div class="dropdown-menu table-dropdown">
                                                <a class="dropdown-item" href="{{route('admin.event-type.edit',$programeData->id)}}">Edit</a>
