                ...
                <table class="dt-select-table table dataTable no-footer dt-checkboxes-select " id="DataTables_Table_3 " aria-describedby="DataTables_Table_3_info ">
                    <thead>
                        <tr>
                            ...
                            <th onclick="return shorting('application_number','{{$order_by}}');" class="sorting @if(isset($order_type) && $order_type == 'application_number' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'application_number' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0 " aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1" aria-sort="descending " aria-label="Name: activate to sort column ascending ">Application No</th>
                            ...
                            <th onclick="return shorting('reason','{{$order_by}}');" class="sorting   @if(isset($order_type) && $order_type == 'reason' && isset($order_by) && $order_by == 'DESC') sorting_desc @elseif(isset($order_type) && $order_type == 'reason' && isset($order_by) && $order_by == 'ASC') sorting_asc @endif " tabindex="0" aria-controls="DataTables_Table_3 " rowspan="1 " colspan="1 " s="" aria-label="Programe Name: activate to sort column ascending ">Reason</th>
                        ...
                        @if(count($programme))
                            @foreach($programme as $key => $programeData)
                                <tr>
                                    ...
                                    <a href="#">@if(isset($programeData->created_at) && !empty($programeData->created_at)) {{date('Y-m-d H:i:s' , strtotime($programeData->created_at))}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="#">@if(isset($programeData->application_number) && !empty($programeData->application_number)) {{$programeData->application_number}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="#">@if(isset($programeData->programme_code) && !empty($programeData->programme_code)) {{$programeData->programme_code}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="#">@if(isset($programeData->programme_name) && !empty($programeData->programme_name)) {{$programeData->programme_name}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="#">@if(isset($programeData->reason) && !empty($programeData->reason)) {{$programeData->reason}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="#">@if(isset($programeData->start_date) && !empty($programeData->start_date)) {{date('Y-m-d' , $programeData->start_date)}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="#">@if(isset($programeData->end_date) && !empty($programeData->end_date)) {{date('Y-m-d' , $programeData->end_date)}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty"><span class="badge rounded-pill badge-custom @if(isset($programeData->status) && $programeData->status == '1') green @else gray @endif">@if(isset($programeData->status) && $programeData->status == '1') Completed @else Failed @endif</span></td>
                                </tr>
                            @endforeach
                        @else
                        <td colspan="4"></td>
                ...
                <div class="bottom-show-padding">
                    <div class="row custom-show-drop-down ">
                        <div class="col-sm-12 col-md-6">
                            ...
                            @if(isset($paginate) && !empty($paginate) && $countPrograme > $paginate)
                                ...
                                <div class="dataTables_info " id="DataTables_Table_3_info " role="status " aria-live="polite ">
                                    <p>Showing <span>@if(isset($page) && !empty($page)) {{$page}} @endif</span> to <span>@if(isset($paginate) && !empty($paginate)) {{$paginate}} @endif</span> of <span>@if(isset($countPrograme) && !empty($countPrograme)) {{$countPrograme}} @endif</span> entries</p>
                                </div>
                                @endif
                            </div>
                        </div> 
