            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-lg-8">
                    <div class="action-buttons d-flex justify-content-end content_start">
                        ...
                        <div class="data-buttons">
                            <button type="button" wire:click="$set('tabSearch', '1')" class="flex-button gray @if(isset($tabSearch) && $tabSearch == '1') active @endif">
                              <sapn>Disabled</sapn>
                        ...
                        @php  $i=1; @endphp        
                            @foreach ($members as $key => $memberData)
                                <tr>
                                    ...
                                    <a href="{{route('admin.memberDetail',[$memberData->id,'show'])}}">@if(isset($memberData->created_at) && !empty($memberData->created_at)) {{date('Y-m-d H:i:s' , strtotime($memberData->created_at))}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.memberDetail',[$memberData->id,'show'])}}">@if(isset($memberData->application_number) && !empty($memberData->application_number)) {{$memberData->application_number}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.memberDetail',[$memberData->id,'show'])}}">@if(isset($memberData->email_address) && !empty($memberData->email_address)) {{$memberData->email_address}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.memberDetail',[$memberData->id,'show'])}}">@if(isset($memberData->title) && !empty($memberData->title)) {{$memberData->title}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.memberDetail',[$memberData->id,'show'])}}">@if(isset($memberData->gender) && !empty($memberData->gender)) {{$memberData->gender}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.memberDetail',[$memberData->id,'show'])}}">@if(isset($memberData->surname) && !empty($memberData->surname)) {{$memberData->surname}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.memberDetail',[$memberData->id,'show'])}}">@if(isset($memberData->given_name) && !empty($memberData->given_name)) {{$memberData->given_name}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.memberDetail',[$memberData->id,'show'])}}">@if(isset($memberData->chinese_name) && !empty($memberData->chinese_name)) {{$memberData->chinese_name}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.memberDetail',[$memberData->id,'show'])}}">@if(isset($memberData->nationality) && !empty($memberData->nationality)) {{$memberData->nationality}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.memberDetail',[$memberData->id,'show'])}}">@if(isset($memberData->contact_tel_no) && !empty($memberData->contact_tel_no)) {{$memberData->contact_tel_no}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty">
                                    <a href="{{route('admin.memberDetail',[$memberData->id,'show'])}}">@if(isset($memberData->study_country) && !empty($memberData->study_country)) {{$memberData->study_country}} @endif</a></td>
                                    <td valign="top" colspan="1" class="dataTables_empty" >
...
<script>
function checkprogrammememberuserstatus(value,id) {
Swal.fire({
title: "Are you sure?",
...
function checkprogrammememberstatus(value,id) {
Swal.fire({
title: "Are you sure?",
text: "Are you sure change status.",
icon: "warning",
