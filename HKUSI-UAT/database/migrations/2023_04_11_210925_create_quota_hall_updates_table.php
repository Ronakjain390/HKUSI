...
class CreateQuotaHallUpdatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('quota_hall_updates', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::table('quota_hall_updates', function($table)
        {
            $table->dropForeign('quota_hall_updates_hall_setting_id_foreign');
            ...
            $table->dropForeign('quota_updates_quota_hall_id_foreign');
            $table->foreign('quota_hall_id')->references('id')->on('quota_halls');
        });
        Schema::dropIfExists('quota_hall_updates');
    }
}
