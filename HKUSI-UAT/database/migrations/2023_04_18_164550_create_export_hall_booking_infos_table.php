...
class CreateExportHallBookingInfosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('export_hall_booking_infos', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::table('export_hall_booking_infos', function (Blueprint $table) {
            $table->dropForeign('export_hall_booking_infos_export_data_info_id_foreign');
            $table->foreign('export_data_info_id')->references('id')->on('export_data_infos');
            $table->dropForeign('export_hall_booking_infos_hall_booking_info_id_foreign');
            $table->foreign('hall_booking_info_id')->references('id')->on('hall_booking_infos');
            $table->dropForeign('export_hall_booking_infos_hall_setting_id_foreign');
            $table->foreign('hall_setting_id')->references('id')->on('hall_settings');
            $table->dropForeign('export_hall_booking_infos_quota_id_foreign');
            $table->foreign('quota_id')->references('id')->on('quotas');
            $table->dropForeign('export_hall_booking_infos_quota_hall_id_foreign');
            $table->foreign('quota_hall_id')->references('id')->on('quota_halls');
            $table->dropForeign('export_hall_booking_infos_quota_room_id_foreign');
            $table->foreign('quota_room_id')->references('id')->on('quota_rooms');
        });
        Schema::dropIfExists('export_hall_booking_infos');
    }
}
