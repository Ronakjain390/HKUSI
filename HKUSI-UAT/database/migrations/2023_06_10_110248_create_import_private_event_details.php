...
class CreateImportPrivateEventDetails extends Migration
{
    /**
     * Run the migrations.
    ...
    public function up()
    {
        Schema::create('import_private_event_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('import_private_event_details');
    }
}
