...
class EventSettingManagement extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        //     $eventData = $eventData->where('user_type_id',$this->user_type_id)->paginate($this->paginate);
        // }else{
            $eventData = $eventData->paginate($this->paginate);
        // }
        
        // if (isset($this->user_type_id) && !empty($this->user_type_id)) {
        //     $this->enabled = EventSetting::where('user_type_id',$this->user_type_id)->where('status','Enabled')->count();
        //     $this->disabled = EventSetting::where('user_type_id',$this->user_type_id)->where('status','Disabled')->count();
        //     $this->close = EventSetting::where('user_type_id',$this->user_type_id)->where('status','Closed')->count();
        //     $this->full = EventSetting::where('user_type_id',$this->user_type_id)->where('status','Full')->count();
        //     $this->countMember = EventSetting::where('user_type_id',$this->user_type_id)->count();
        // }else{
            $this->enabled = EventSetting::where('status','Enabled')->count();
            $this->disabled = EventSetting::where('status','Disabled')->count();
            $this->cancelled = EventSetting::where('status','Cancelled')->count();
        ...
        return view('livewire.admin.event-setting.index',compact('eventData','programmerecord'));
    }
