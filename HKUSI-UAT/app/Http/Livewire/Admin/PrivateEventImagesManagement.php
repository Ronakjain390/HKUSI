...
class PrivateEventImagesManagement extends Component
{
    use WithPagination;
    // Private Event Image Managment By Akash
    ...
    public function render()
    {
        ...
        if (isset($this->order_type) && $this->order_type != '') {
            ...
            $this->close = PrivateEventSetting::where('status','Closed')->count();
        ...
        return view('livewire.admin.private-event-setting.private-event-image',compact('eventData','programmerecord'));
    }
    ...
    public function destroy($id)
    {
        ...
        session()->flash('success', 'Private Event delete successfully.');
    }
    ...
    {   
        ...
        session()->flash('message', 'Private Event status updated successfully.'); 
    }
