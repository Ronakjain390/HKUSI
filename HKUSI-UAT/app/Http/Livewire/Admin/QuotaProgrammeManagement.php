...
class QuotaProgrammeManagement extends Component
{
    use WithPagination;
    ...
    {
        $QoutaHallProgramme = (new QuotaProgramme)->newQuery();
        ...
        $QoutaHallProgramme = $QoutaHallProgramme->where('quota_id',$this->quota_id)->paginate($this->paginate);
        $getprogrammeid = QuotaProgramme::where('quota_id',$this->quota_id)->pluck('programme_id')->toArray();
        ...
        $this->countMember = '';
        return view('livewire.admin.quota.programme',compact('QoutaHallProgramme'));
    }

    public function stautsMemberProgrameChange($id) 
    {   
        $status = QuotaProgramme::find($id); 
        if (empty($id)) {
    ...
    {
        $QoutaHallProgramme =QuotaProgramme::where('quota_id',$this->quota_id)->where('programme_id',$id)->first();
