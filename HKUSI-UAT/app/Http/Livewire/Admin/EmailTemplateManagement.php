...
class EmailTemplateManagement extends Component
{
   ...
   public function updatingSearch()
    ...
    {
        $programme = (new EmailTemplate)->newQuery();
        ...
        $this->totalEnabled =  '';
        $this->totalDisabled = '';
        $this->programe_codedata = EmailTemplate::orderBy('id','ASC')->get();
        $this->countMember = EmailTemplate::count();
        return view('livewire.admin.email-template.index',compact('programme'));
    }
    ...
    public function destroy($id)
    {
        ...
        session()->flash('success', 'EmailTemplate delete successfully.');
    }

    public function statusChange($id) 
    {   
        $status = EmailTemplate::find($id); 
        if (empty($id)) {
