...
class AdminappversionManagement extends Component
{
    use WithPagination;
    ...
    {
        $language = (new AppVersion)->newQuery();
        ...
        $this->countMember = AppVersion::count();
        return view('livewire.admin.adminappversion.index', compact('language'));
    }
