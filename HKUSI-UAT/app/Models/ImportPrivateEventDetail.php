...
class ImportPrivateEventDetail extends Model
{
   use HasFactory,LogsActivity;
   // Import Private Event Detail Model Created By Akash
    protected $fillable = ['import_data_info_id','hall_setting_id','event_category_id','event_name', 'description', 'location', 'date','start_time','end_time', 'application_deadline','quota','unit_price','additional_info','notes','booking_limit','thumbanil','main_image','thumb_image','status','language_id','qouta_status','assembly_location','terms_condition','terms_link','pre_arrival','pre_link','reason'];
